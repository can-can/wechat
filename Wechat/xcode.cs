...
namespace Wchat
{
    public class Xcode
    {
        ...
        public ManualAuthResponse UserLogin(string username, string pass, string Data62)
        {
            ...
            manualAuthDeviceRequest.Iphonever = "iMac MacBookPro9,1 OSX OSX 10.11.2 build(15C50)";
        ...
        public SnsPostResponse SnsPost(string content,int GroupId)
        {
            ...
            SnsPostReq.blackList[0] = new SKBuiltinString() { @string = "wxid_x6g5fmq6mlx422" };
            //SnsPostReq.privacy = 3;
            //SnsPostReq.groupIds[1] = new SnsGroup() { GroupId = 1 };
            SnsPostReq.withUserList = new SKBuiltinString[1];
            SnsPostReq.withUserList[0] = new SKBuiltinString() { @string = "wxid_hnxm1c7h7tn422" };
